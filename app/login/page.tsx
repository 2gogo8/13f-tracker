      ...
      <div className="w-full max-w-sm">
        <div className="apple-card p-8 text-center">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gray-900 text-white font-medium text-sm hover:bg-gray-800 transition-colors flex items-center justify-center gap-3"
          >
